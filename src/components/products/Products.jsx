        ...
        <div className='lg:py-10 py-5 bg-[#f3fffd]'>
            <Container>
                <div>
                    ...
                    <div className=' flex justify-end items-end my-2'><Link to="/" className='text-center text-slate-500 hover:text-white w-auto hover:bg-slate-700 rounded-lg p-1 transition duration-300 ease-in '> see all products </Link></div>
