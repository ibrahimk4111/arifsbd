                                ...
                                <Link to="/productDetails/:id" key={index}>
                                    <div className=' relative group border-[1px] rounded-md'>
                                        <div className=' flex justify-center items-center h-60 overflow-hidden '>
                                            <img src={`${item.img}`} alt={item.id} className=' object-cover max-h-full max-w-[90%] lg:w-[50%] w-[80%] h-auto group-hover:skew-y-2 group-hover:scale-125 sca transition-all duration-700 ease-in' loading=' lazy ' />
                                        </div>
